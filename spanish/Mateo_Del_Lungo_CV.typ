...
#strong[Lenguajes de Programación:] #rendercv-tags("C#, Java, Kotlin, Javascript, Typescript")

#strong[Bases de Datos:] #rendercv-tags("SQL Server, PostgreSQL, MongoDB")

#strong[Tecnologías:] #rendercv-tags(".NET, Angular, Capacitor, Spring Boot, Maven, SignalR, JWT, Microservicios, HTML, CSS, Tailwind, Bootstrap")

#strong[Herramientas:] #rendercv-tags("Git, Linux, Docker, Testing, Playwright, CI/CD, GitHub Actions, Cloudflare Pages")

#strong[Metodologías:] #rendercv-tags("Scrum, Kanban, Agentic AI - Opencode")

== Proyectos Relevantes

  #regular-entry(
  [
    #strong[Aplicación de Chat en Tiempo Real #link("https://chat-collab-frontend.onrender.com/")[\[Live\]] #link("https://github.com/Tomilomi/chat-collab-react")[\[Frontend\]] #link("https://github.com/Tomilomi/chat-in-realtime-collab")[\[Backend\]]]
  ...
  main-column-second-row: [
    ...
    #summary[Desarrollo de una plataforma de mensajería escalable en un entorno colaborativo, utilizando SignalR para comunicación bidireccional de baja latencia. Participé en el desarrollo integral del sistema (Full-stack).]
  ...
  #regular-entry(
  [
    #strong[Portfolio Tatuajes #link("https://biantattoo.pages.dev/")[\[Live\]] #link("https://github.com/Mudo0/portfolio-bianca")[\[Repo\]]]
